    ...
    <Container>
      ...
      <div>
        ...
        {actors.length > 0 || displayUserSavedAdvancedSearch ? (
          displayResults('actors').map((actor) => <Result key={actor}>{actor}</Result>)
        ) : (
      ...
      <div>
        ...
        {displayResults('directors').length > 0 ? (
          displayResults('directors').map((director, i) => (
            <Result key={director}> {director}, </Result>
          ))
        ) : (
          <ResultSpan>N/A</ResultSpan>
        )}
      ...
      <div>
        ...
        {displayResults('writers').length > 0 ? (
          displayResults('writers').map((writer) => (
            <Result key={writer}> {writer}, </Result>
          ))
        ) : (
          <ResultSpan>N/A</ResultSpan>
        )}
